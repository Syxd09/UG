...
<AnimatePresence>
  {menuOpen && (
    ...
    >
      ...
      <div className="gallery bg-gradient-to-r from-cyan-400 via-pink-500 to-orange-500 text-white text-center py-20 animate__animated animate__fadeInDown">
        <h1 className="text-7xl mt-2 p-6 font-bold mb-4">Gallery</h1>
      ...
      <section className="bg-white dark:bg-dark1 py-20" style={{ backgroundImage: "url('/background.jpg')", backgroundSize: 'cover' }}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl font-extrabold text-center leading-tight uppercase tracking-wide font-sans gradient-glow-text animate-pulseSlow">
            Our Gallery
          </h2>
          <GalleryModal />
        </div>
